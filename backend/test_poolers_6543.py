...
print("Scanning regions to find the active pooler region on PORT 6543...")
for region in regions:
    host = f"aws-0-{region}.pooler.supabase.com"
    # Port 6543 is Transaction mode pooler in Supabase
    ...
    try:
        ...
        print(f"\nSUCCESS! Found region on port 6543: {region}")
